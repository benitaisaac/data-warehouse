...
with DAG(
    ...
    train_input_table      = "USER_DB_COBRA.RAW.TWO_STOCK_V2"
    train_view             = "USER_DB_COBRA.ADHOC.TWO_STOCK_VIEW"
    forecast_table         = "USER_DB_COBRA.ADHOC.TWO_STOCK_FORECAST"
    forecast_function_name = "USER_DB_COBRA.ANALYTICS.PREDICT_TWO_STOCK_PRICE"
    final_table            = "USER_DB_COBRA.ANALYTICS.TWO_STOCK"
