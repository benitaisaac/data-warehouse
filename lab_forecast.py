...
with DAG(
    ...
    train_input_table = "raw.TWO_STOCK_V2"
    train_view = "adhoc.two_stock_view"
    forecast_table = "adhoc.two_stock_forecast"
    forecast_function_name = "analytics.predict_two_stock_price"
    final_table = "analytics.two_stock"
